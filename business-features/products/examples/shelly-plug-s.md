...
<figure><img src="../../../.gitbook/assets/image (45) (1).png" alt="" width="563"><figcaption><p>Shelly Plug S Configuration Options</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/image (69) (1).png" alt="" width="563"><figcaption><p>Shelly Plug S - Advanced MQTT server configuration</p></figcaption></figure>
...
<div align="left"><figure><img src="../../../.gitbook/assets/image (542).png" alt="" width="563"><figcaption><p>Shelly Plug S - Property configuration for storing current power</p></figcaption></figure></div>
...
<figure><img src="../../../.gitbook/assets/image (556).png" alt="" width="563"><figcaption><p>Shelly Plug S - Property configuration for storing relay state</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/image (576).png" alt="" width="563"><figcaption><p>Shelly Plug S - Bucket Configuration for storing temperature</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/image (545).png" alt="" width="563"><figcaption><p>Shelly Plug S - API Resource to modify on/off state</p></figcaption></figure>
...
However, this use case can be improved a little bit. For example, suppose that it is required to display the current relay state to avoid always showing the default 'false' value set before. For this purpose, we can reference other properties or even API responses. To reference a property, i.e., the 'relay' one configured on the [Properties](../product-profile/properties.md) section, we can set a default value with `=property.<property_name>`:
...
<figure><img src="../../../.gitbook/assets/image (73) (1).png" alt=""><figcaption><p>Shelly Plug S - Dashboard</p></figcaption></figure>
