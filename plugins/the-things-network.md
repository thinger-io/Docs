...
![TTN aplication configuration ](../.gitbook/assets/image%20%284%29.png)
...
![TTN Payload processing configuration](../.gitbook/assets/image%20%285%29.png)
...
![](../.gitbook/assets/image%20%289%29.png)[Github source code](https://github.com/thinger-io/ttn-plugin)
...
![The Things Network Uplink Flow Overview](../.gitbook/assets/image.png)
...
1. Create a new device and its associated data bucket if the device does not exists on the platform. It is based on the `dev_id` field. 
...
![Sample device information stored in Thinger.io for every TTN device](../.gitbook/assets/image%20%283%29.png)
...
![HTTP Device created by the TTN Plugin](../.gitbook/assets/image%20%287%29.png)
...
![The Things Network Downlink Flow Overview](../.gitbook/assets/image%20%282%29.png)
