...
Para configurar el downlink behavior, solo es necesario añadir una “Download API Key” en la configuración del Webhook. as explained below: 
...
Finally, paste this string into the "downlink API Key" input of the webhook form.
